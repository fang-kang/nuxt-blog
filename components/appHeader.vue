<template>
  <header class="app-header">
    <nav class="nav_wrap clearfix" v-if="!isMobile">
      <h2 class="logo" style="margin-right: 40px">
        <a href="/" title="凌烟">凌烟</a>
      </h2>
    ...
    <nav class="nav_wrap clearfix" v-else>
      ...
      <el-collapse-transition>
        <ul class="nav_box transition-box" v-show="isShow">
          ...
          <nuxt-link to="/archives" tag="li" @click.native="menuToggle"
            >归档</nuxt-link
          >
          <nuxt-link to="/friends" tag="li" @click.native="menuToggle"
            >友链</nuxt-link
          >
          <nuxt-link to="/about" tag="li" @click.native="menuToggle"
            >关于我</nuxt-link
          >
          <li>
            <form
              autocomplete="off"
              @submit.prevent="searchHandleMob"
              style="width: 96%"
            >
              <el-input
                type="search"

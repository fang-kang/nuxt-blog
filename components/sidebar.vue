    ...
    <section class="module-css">
      ...
      <div class="module-item-wrap contact-me">
        <div class="contact-method clearfix">
          <div class="contact-label">邮箱：</div><div class="contact-detail"><a href="mailto:1793980864@qq.com">1793980864@qq.com</a></div>
        </div>
        <div class="contact-method clearfix">
          <div class="contact-label">Github：</div><div class="contact-detail"><a href="https://github.com/fang-kang" target="_blank">
          凌烟FK</a></div>
        </div>
        <div  style="text-align: center;padding: 10px 0;margin: 15px 0;font-size: 12px;">
          <p style="color: #333;">微信</p>
          <img width="130" height="130" src="@/assets/images/wx.png" alt="微信">
